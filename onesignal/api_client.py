...
class ApiClient(object):
    ...
    def __call_api(
        ...
        header_params['OS-Usage-Data'] = "kind=sdk, sdk-name=onesignal-python, version=1.2.1"
        if self.cookie:
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.begin_live_activity  # this is an instance of the class Endpoint
        api_instance.begin_live_activity()  # this invokes api_instance.begin_live_activity.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.begin_live_activity.callable or self.callable in this class
