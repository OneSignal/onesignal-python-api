...
from onesignal import rest
from onesignal.configuration import Configuration
from onesignal.exceptions import ApiTypeError, ApiValueError, ApiException
from onesignal.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/5.11.3/python'
    ...
    def __call_api(
        ...
        header_params['OS-Usage-Data'] = "kind=sdk, sdk-name=onesignal-python, version=5.11.3"
        if self.cookie:
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cancel_notification  # this is an instance of the class Endpoint
        api_instance.cancel_notification()  # this invokes api_instance.cancel_notification.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_notification.callable or self.callable in this class
