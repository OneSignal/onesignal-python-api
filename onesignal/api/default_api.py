...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_subscription_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'alias_label': 'path',
                    'alias_id': 'path',
                    'create_subscription_request_body': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.fetch_aliases_endpoint = _Endpoint(
            settings={
                'response_type': (UserIdentityResponse,),
                'auth': [
                    'app_key'
                ],
                'endpoint_path': '/apps/{app_id}/subscriptions/{subscription_id}/user/identity',
                'operation_id': 'fetch_aliases',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.fetch_user_endpoint = _Endpoint(
            settings={
                'response_type': (User,),
                'auth': [
                    'app_key'
        ...
        self.fetch_user_identity_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse200,),
                'auth': [
                    'app_key'
                ...
                'operation_id': 'fetch_user_identity',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_eligible_iams_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2003,),
                'auth': [
                    'app_key'
                ],
                'endpoint_path': '/apps/{app_id}/subscriptions/{subscription_id}/iams',
                'operation_id': 'get_eligible_iams',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.identify_user_by_alias_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse200,),
                'auth': [
                    'app_key'
                ...
                'endpoint_path': '/apps/{app_id}/users/by/{alias_label}/{alias_id}/identity',
                'operation_id': 'identify_user_by_alias',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'alias_label': 'path',
                    'alias_id': 'path',
                    'user_identity_request_body': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.identify_user_by_subscription_id_endpoint = _Endpoint(
            settings={
                'response_type': (UserIdentityResponse,),
                'auth': [
                    'app_key'
                ...
                'endpoint_path': '/apps/{app_id}/subscriptions/{subscription_id}/user/identity',
                'operation_id': 'identify_user_by_subscription_id',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_subscription_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'app_id': 'path',
                    'subscription_id': 'path',
                    'update_subscription_request_body': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_subscription(
        ...
        **kwargs
        ...
        >>> thread = api.create_subscription(app_id, alias_label, alias_id, create_subscription_request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['alias_id'] = \
            alias_id
        kwargs['create_subscription_request_body'] = \
            create_subscription_request_body
    ...
    def fetch_aliases(
        ...
        **kwargs
        ...
        """fetch_aliases  # noqa: E501

        Lists all Aliases for the User identified by :subscription_id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.fetch_aliases(app_id, subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['subscription_id'] = \
            subscription_id
        return self.fetch_aliases_endpoint.call_with_http_info(**kwargs)
    ...
    def fetch_user(
        ...
        **kwargs
        ...
        """fetch_user  # noqa: E501

        Returns the User’s properties, Aliases, and Subscriptions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.fetch_user(app_id, alias_label, alias_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['alias_id'] = \
            alias_id
        return self.fetch_user_endpoint.call_with_http_info(**kwargs)
    ...
    def fetch_user_identity(
        ...
        **kwargs
        ...
        """fetch_user_identity  # noqa: E501

        Lists all Aliases for the User identified by (:alias_label, :alias_id).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.fetch_user_identity(app_id, alias_label, alias_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['alias_id'] = \
            alias_id
        return self.fetch_user_identity_endpoint.call_with_http_info(**kwargs)
    ...
    def get_eligible_iams(
        self,
        app_id,
        subscription_id,
        **kwargs
    ):
        """get_eligible_iams  # noqa: E501

        Manifest of In-App Messages the Subscription is eligible to display by the SDK.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_eligible_iams(app_id, subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['subscription_id'] = \
            subscription_id
        return self.get_eligible_iams_endpoint.call_with_http_info(**kwargs)
    ...
    def identify_user_by_alias(
        ...
        **kwargs
        ...
        """identify_user_by_alias  # noqa: E501

        Upserts one or more Aliases to an existing User identified by (:alias_label, :alias_id).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.identify_user_by_alias(app_id, alias_label, alias_id, user_identity_request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['alias_id'] = \
            alias_id
        kwargs['user_identity_request_body'] = \
            user_identity_request_body
        return self.identify_user_by_alias_endpoint.call_with_http_info(**kwargs)

    def identify_user_by_subscription_id(
        self,
        app_id,
        subscription_id,
        user_identity_request_body,
        **kwargs
        ...
        """identify_user_by_subscription_id  # noqa: E501

        Upserts one or more Aliases for the User identified by :subscription_id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.identify_user_by_subscription_id(app_id, subscription_id, user_identity_request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['user_identity_request_body'] = \
            user_identity_request_body
        return self.identify_user_by_subscription_id_endpoint.call_with_http_info(**kwargs)
    ...
    def update_subscription(
        ...
        **kwargs
        ...
        >>> thread = api.update_subscription(app_id, subscription_id, update_subscription_request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['subscription_id'] = \
            subscription_id
        kwargs['update_subscription_request_body'] = \
            update_subscription_request_body
