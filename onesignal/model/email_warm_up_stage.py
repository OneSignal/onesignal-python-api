...
class EmailWarmUpStage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start, end, quota, *args, **kwargs):  # noqa: E501
        """EmailWarmUpStage - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            acked (bool): Whether this stage has been picked up and acknowledged by the warm-up scheduler. Not accepted on create. This is only present when reading back a campaign.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, start, end, quota, *args, **kwargs):  # noqa: E501
        """EmailWarmUpStage - a model defined in OpenAPI
