...
class StartLiveActivityRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'event': (str,),  # noqa: E501
            'activity_id': (str,),  # noqa: E501
            'event_attributes': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            ...
            'included_segments': ([str], none_type,),  # noqa: E501
            'excluded_segments': ([str], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'event_attributes': 'event_attributes',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, activity_id, event_attributes, event_updates, contents, headings, *args, **kwargs):  # noqa: E501
        """StartLiveActivityRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            event (str): defaults to "start", must be one of ["start", ]  # noqa: E501
            ...
            included_segments ([str], none_type): Segment names to include. Only compatible with excluded_segments.. [optional]  # noqa: E501
            excluded_segments ([str], none_type): Segment names to exclude. Only compatible with included_segments.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, activity_id, event_attributes, event_updates, contents, headings, *args, **kwargs):  # noqa: E501
        """StartLiveActivityRequest - a model defined in OpenAPI
