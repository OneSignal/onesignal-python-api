...
class UpdatePlayerTagsRequestBody(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdatePlayerTagsRequestBody - a model defined in OpenAPI
