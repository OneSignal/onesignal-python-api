...
class BeginLiveActivityRequest(ModelNormal):
    ...
    attribute_map = {
        'push_token': 'push_token',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, push_token, subscription_id, *args, **kwargs):  # noqa: E501
        """BeginLiveActivityRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, push_token, subscription_id, *args, **kwargs):  # noqa: E501
        """BeginLiveActivityRequest - a model defined in OpenAPI
