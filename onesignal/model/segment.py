...
class Segment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, filters, *args, **kwargs):  # noqa: E501
        """Segment - a model defined in OpenAPI

        Args:
            name (str): Name of the segment.  You'll see this name on the Web UI.
            filters ([FilterExpression]): Filter or operators the segment will have.  For a list of available filters with details, please see Send to Users Based on Filters.
        ...
        Keyword Args:
            ...
            id (str): UUID of the segment.  If left empty, it will be assigned automaticaly.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, filters, *args, **kwargs):  # noqa: E501
        """Segment - a model defined in OpenAPI
