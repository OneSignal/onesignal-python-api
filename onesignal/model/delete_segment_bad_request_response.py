...
class DeleteSegmentBadRequestResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DeleteSegmentBadRequestResponse - a model defined in OpenAPI
