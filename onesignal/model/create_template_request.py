...
class CreateTemplateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_id, name, contents, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_id, name, contents, *args, **kwargs):  # noqa: E501
        """CreateTemplateRequest - a model defined in OpenAPI
