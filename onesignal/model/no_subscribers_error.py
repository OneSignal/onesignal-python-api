...
class NoSubscribersError(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NoSubscribersError - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Returned if no subscribed players. .  # noqa: E501

        Keyword Args:
            value ([str]): Returned if no subscribed players. .  # noqa: E501
