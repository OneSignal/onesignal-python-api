...
class BasicNotification(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'android_channel_id': (str, none_type,),  # noqa: E501
            'huawei_channel_id': (str, none_type,),  # noqa: E501
            'existing_android_channel_id': (str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BasicNotification - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            include_email_tokens ([str]): Deprecated alias for `email_to`. Target specific email addresses. If an email does not correspond to an existing user, a new user will be created. Example: nick@catfac.ts. Limit of 2,000 entries per REST API call. Prefer `email_to` in new integrations. . [optional]  # noqa: E501
            email_to ([str]): Recommended for Sending Emails - Target specific email addresses. If an email does not correspond to an existing user, a new user will be created. Example: nick@catfac.ts. Limit of 2,000 entries per REST API call. Supersedes the deprecated `include_email_tokens` field. . [optional]  # noqa: E501
            ...
            android_channel_id (str, none_type): Channel: Push Notifications Platform: Android The Android Oreo Notification Category to send the notification under. See the Category documentation on creating one and getting it's id. . [optional]  # noqa: E501
            ...
            existing_android_channel_id (str, none_type): Channel: Push Notifications Platform: Android Use this if you have client side Android Oreo Channels you have already defined in your app with code. . [optional]  # noqa: E501
